...
public class JavaTypeResolver  {
    ...
    protected Map<Integer, JdbcTypeInformation> typeMap = new HashMap<Integer, JdbcTypeInformation>();
    
    public static JavaTypeResolver instance = new JavaTypeResolver();
    ...
    public static FullyQualifiedJavaType getJavaTypeInfo(Integer type){
    	return instance.typeMap.get(type).getFullyQualifiedJavaType();
    }
